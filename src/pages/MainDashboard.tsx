    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {[
          ...
          { name: "Receive Stock", path: "/stock/receive-stock" },
          { name: "Sort Stock", path: "/stock/sort-stock" },
          { name: "Stock Report", path: "/stock/stock-report" },
          { name: "Suppliers", path: "/suppliers/view-suppliers" },
          { name: "Rejected Poles", path: "/suppliers/rejected-poles" },
          { name: "Treatment Log", path: "/treatments/treatment-log" },
          { name: "Treatment Report", path: "/treatments/treatment-report" },
